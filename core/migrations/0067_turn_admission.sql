...
CREATE TABLE agent.turn_admission_states (
  ...
  contact_id VARCHAR(600) NOT NULL REFERENCES conversation.contact_profiles(contact_id),
  last_message_id VARCHAR(600) NOT NULL REFERENCES conversation.messages(message_id),
