 ...
 * product state.
 *
 * The registry NEVER collapses "upstream can do it", "Server2 exposes it"
 ...
 *   serverContract:  what Server2's knowledge boundary exposes (whitelist)
 ...
 * - retrieval: upstream 200, Server2 whitelist missing tenants/kv → fixed by
...
const BASELINE: Record<KnowledgeCapability, KnowledgeCapabilityState> = {
  ...
  retrieval: {
    ...
    ui: "missing",
    reason: "upstream tenants/kv 200; Server2 whitelist missing — explicit retrieval-settings contract (P0.2)",
  },
  models: {
    capability: "models",
    upstream: "available",
